...
**Rot:** evergreen  ·  **Verified:** 2026-06-22
- ➕ 2026-06-22 — ~20 paused ads across all 3 active Divine Designs ad sets showed
  ...
  matches documented Meta behavior. _(src: direct_observation · acct: divine_designs)_
- ➕ 2026-06-22 — all 22 affected creatives are dark posts on one Page (`766046059925199`)
  ...
  `pages_read_engagement`; our token lacks it). _(src: direct_observation · acct: divine_designs)_
- ➕ 2026-06-22 — after both business apps ("codex", "AI Ad Analysis") were published to Live,
  ...
  on re-review — re-enable/edit each blocked ad to trigger it.** _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-22 — validate-only POST to change `custom_audiences` was rejected on all 3 ad sets
  ("can't be changed because your campaign uses Advantage+ audience"). _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-22 — `advantage_audience=0` with `age_range` present → HTTP 400 subcode 1487079
  ...
  `{"success": true}` on all 3 ad sets. _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-24 — pulled `degrees_of_freedom_spec` on active Divine Designs ads: the proven
  ...
  The new API-created ad has ALL of them off (API default without opt-in). Enhancement *lift* is NOT
  cleanly measurable — no per-feature insights breakdown; confounded. _(src: correlational · acct: divine_designs)_
- ➕ 2026-06-24 — practitioner consensus (Jon Loomer, Metalla, Meta Help): keep **additive/visual**
  ...
  Cited 2026-06-24 — Meta Business Help Center, "About standard enhancements for Advantage+ creative",
  verbatim: "advertisers saw a 4% decrease in median cost per result" — https://www.facebook.com/business/help/ .
  This is **external** evidence — grounding tier `external`, **capped 🔴 Low**: a hypothesis worth
  testing, **not** account truth. It does not raise this entry's band — the 🟡 Medium rests on the
  first-party own-account reads above; the keep-additive / kill-Text-Improvements claim is to
  **confirm via A/B** on this account before being trusted as more than a prior.
  _(src: external · acct: —)_
...
- ➕ 2026-06-24 — correlational join (30 ads, ≥$100 spend, 120d, spend-weighted ROAS): the
  ...
  "keep additive on, don't blanket-disable." Causal proof needs an A/B test. _(src: correlational · acct: divine_designs)_
...
**Confidence:** 🟢 High →  ·  **Domain:** platform
**Rot:** evergreen  ·  **Verified:** 2026-06-23
- ➕ 2026-06-23 — creating a video ad with 5 primary texts (`asset_feed_spec.bodies`) into the
  ...
  subcode 3858504) — so omit it. _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-23 — 3 Divine Designs video ads (`Selfie Mom - Copy`, `Cody`, `selfie FM SP`) showed
  ...
  didn't satisfy every placement in the set and there was no format fallback. _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-23 — **fix confirmed live:** setting the paused "Selfie" ad set to manual placements
  ...
  `selfie FM SP` (issues → none). _(src: direct_observation · acct: divine_designs)_
...
- ➕ 2026-06-22 — right after disabling AA, an `effective_status=["ACTIVE"]` listing returned only
  1 of 3 ad sets; all 3 read ACTIVE again minutes later. _(src: direct_observation · acct: divine_designs)_
...
**Confidence:** 🟢 High →  ·  **Domain:** platform
**Rot:** evergreen  ·  **Verified:** 2026-06-22
- ➕ 2026-06-22 — write calls accepted; the Linux/macOS-only `meta` CLI was fully retired. _(src: direct_observation · acct: —)_
...
- ➕ 2026-06-22 — each Divine Designs ad set pairs a distinct audience with a distinct creative
  mix, so ad-set ROAS can't be attributed to audience vs creative. _(src: model_inference · acct: —)_
...
- ➕ 2026-06-22 — 30-day window: engaged ad set 3.74 ROAS / ~$67 AOV vs low-value 2.04 / ~$47.
  Single window, cross-sectional, **confounded** by creative mix + Advantage+ being on — weak.
  `verify: account_metrics --account divine_designs --level adset --date-from 2026-05-23 --date-to 2026-06-22`
  _(src: correlational · acct: divine_designs · metric: engaged_adset_roas=3.74)_
...
**Confidence:** 🟡 Medium ↑  ·  **Domain:** strategy
**Rot:** fast  ·  **Verified:** 2026-06-23
- ➕ 2026-06-23 — 30d `metrics --breakdown`: Instagram 2.79 ROAS vs Facebook 1.94; by `age`,
  18-24 (3.18) and 45-54 (2.93) led, 55-64 (1.41) / 65+ (1.57) lagged. 30d, account-wide, confounded.
  `verify: account_metrics --account divine_designs --level account --date-from 2026-05-24 --date-to 2026-06-23 --breakdown publisher_platform`
...
**Rot:** evergreen  ·  **Verified:** 2026-06-22
- ➕ 2026-06-22 — 30 ads lacked a direct `purchase_roas` field; ROAS is computed from value/spend. _(src: direct_observation · acct: divine_designs)_
